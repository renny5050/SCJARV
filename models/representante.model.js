...
exports.obtenerRepresentantePorPersona = async (codigo_perso) => {
    return await db.getAsync(
        "SELECT * FROM Tb_represent WHERE codigo_perso = ?", 
        [codigo_perso]
    );
};
...
exports.obtenerRepresentantesUnicos = async () => {
    return await db.allAsync(`
        SELECT DISTINCT codigo_perso, codigo_repre, parentesco_r 
        FROM Tb_represent
    `);
};
